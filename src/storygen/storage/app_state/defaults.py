...
ALLOWED_PROVIDERS: frozenset[str] = frozenset(pid for _, pid in PROVIDER_CHOICES)
...
ALLOWED_IMAGE_PROVIDERS: frozenset[str] = frozenset(pid for _, pid in IMAGE_PROVIDER_CHOICES)
