...
def beat_system_prompt(
    *,
    ...
    return (
        ...
        "STYLE VARIETY:\n"
        "Recurring motifs and character traits are welcome, but do not repeat"
        " distinctive phrases verbatim from beat to beat. If a trait matters"
        " again, express it through fresh action, dialogue, sensory detail, or"
        " different wording instead of looping stock descriptors like"
        " 'analytical mind' or 'mathematical precision.'\n\n"
        "CONTINUATION RULES:\n"
